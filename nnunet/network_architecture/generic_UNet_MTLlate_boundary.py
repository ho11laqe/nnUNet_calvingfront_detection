...
class Generic_UNet_MTLlate_boundary(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_MTLlate_boundary, self).__init__()
        ...
        for ds in range(len(self.conv_blocks_localization_1)):
            self.seg_outputs_1.append(conv_op(self.conv_blocks_localization_1[ds][-1].output_channels, num_classes[0]+num_classes[1]+num_classes[2],
